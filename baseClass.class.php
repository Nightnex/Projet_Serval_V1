<?php
    ...
    class baseClass {
        ...
        */
        ...
        /*
        * @var int Récupère le status d'action
        */
        ...
        */
        ...
        /*
        *@param int défini le status d'action
        */
        public function setCurrentStatusAction(int $statusAction){
            $this -> _statusAction = $statusAction;
        }

        /*
        *@return le status d'action
        */
